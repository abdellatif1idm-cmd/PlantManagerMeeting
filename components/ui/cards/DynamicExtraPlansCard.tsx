...
const DynamicExtraPlansCard = ({
  ...
  return (
    <Link
      href={href}
      className="w-full lg:flex-1 duration-500 lg:hover:flex-2"
      prefetch={true}
    >
      <MNBlurWrapper delay={index * 0.05 || 0}>
...
export default DynamicExtraPlansCard;
